...
\begin{minipage}[t]{0.70\textwidth}
    ...
    \begin{tightemize}
        \vspace{10pt}
        \item \textbf{Designed} and developed a React-based application with ChainLit integration,
        centralizing access to multiple leading LLMs in one platform.
        \item \textbf{Built} an intuitive and responsive interface for diverse applications, including
        content generation, code assistance, and data analysis.
        \item \textbf{Engineered} a robust backend to manage API connections, ensuring
